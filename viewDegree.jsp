					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ul class="breadcrumb breadcrumb-style ">
							<li class="breadcrumb-item">
								<h4 class="page-title">View Degree</h4>
							</li>
							...
							<li class="breadcrumb-item active">View Degree</li>
						</ul>
					</div>
				</div>
			</div>
								...
								<table id="tableExport"
									...
									<c:forEach items="${SearchList}" var="p" varStatus="j">
										<tr>
										    <td>${j.count}</td>
											<td> ${p.degree}</td>
											<td> ${p.degreeDescription}</td>
											<td><a href="editDegree?id=${p.id}"><i class="fas fa-pencil-alt "

															style="margin-left: 15px; font-size: 20px;"></i></a> 
															<a href="deleteDegree?id=${p.id}"><i class=" fa fa-trash "
