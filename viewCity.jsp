						...
						<div class="body">
							<div class="table-responsive">
								<table id="tableExport"
									...
									<tbody>
									<c:forEach items="${cityList}" var="p" varStatus="j">
										<tr>
											<td>${j.count} </td>
											<td> ${p.stateVO.stateName}</td>
											<td>${p.cityName}</td>
											<td>${p.cityDescription}</td>
											<td><a href="editCity?Id=${p.id}"><i class="fas fa-pencil-alt "

															style="margin-left: 15px; font-size: 20px;"></i></a> 
															<a href="deleteCity?Id=${p.id}"><i class=" fa fa-trash "
