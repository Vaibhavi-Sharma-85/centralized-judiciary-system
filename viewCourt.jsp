					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ul class="breadcrumb breadcrumb-style ">
							<li class="breadcrumb-item">
								<h4 class="page-title">View Court</h4>
							</li>
							...
							<li class="breadcrumb-item active">View Court</li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="body">
							<div class="table-responsive">
								<table id="tableExport"
									...
									<tbody>
									<c:forEach items="${courtList}" var="p" varStatus="j">
										<tr>
											<td>${j.count} </td>
											<td>${p.courtName} </td>
											<td>${p.courtDescription} </td>
											<td> ${p.stateVO.stateName}</td>
											<td> ${p.cityVO.cityName}</td>
											<td>${p.courtAddress}</td>
											<td><a href="editCourt?Id=${p.id}"><i class="fas fa-pencil-alt "

															style="margin-left: 15px; font-size: 20px;"></i></a> 
															<a href="deleteCourt?Id=${p.id}"><i class=" fa fa-trash "
                                                      style="margin-left: 15px; font-size: 20px; color: #e56767;"></i></a>
													</td>
										</tr>
                                      </c:forEach>
									</tbody>
