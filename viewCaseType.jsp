					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ul class="breadcrumb breadcrumb-style ">
							<li class="breadcrumb-item">
								<h4 class="page-title">View CaseType </h4>
							</li>
							<li class="breadcrumb-item bcrumb-1"><a
								href="../../index.html"> <i class="fas fa-home"></i> Home
							</a></li>
							<li class="breadcrumb-item bcrumb-2"><a href="#"
								onClick="return false;">Manage CaseType </a></li>
							<li class="breadcrumb-item active">View CaseType </li>
						</ul>
					</div>
				</div>
			</div>
								...
								<table id="tableExport"
									...
									<c:forEach items="${SearchList}" var="p" varStatus="j">
										...
										<tr>
											<td>${j.count}</td>
											<td>${p.caseName}</td>
											<td>${p.caseDescription}</td>
											
											<td><a href="editCaseType?id=${p.id}"><i class="fas fa-pencil-alt "

															style="margin-left: 15px; font-size: 20px;"></i></a> 
															<a href="deleteCaseType?id=${p.id}"><i class=" fa fa-trash "
