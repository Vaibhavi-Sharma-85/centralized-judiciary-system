					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ul class="breadcrumb breadcrumb-style ">
							<li class="breadcrumb-item">
								<h4 class="page-title">Add CaseType </h4>
							</li>
							...
							<li class="breadcrumb-item active">Add CaseType</li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								<strong>Add CaseType</strong>
							</h2>
							<ul class="header-dropdown m-r--5">
							
						</div>
						<div class="body">
							<f:form id="form_validation" method="get" action="saveCaseType" modelAttribute="addCaseType" onsubmit="return addCaseType()">
								<div class="form-group form-float">
									<div class="form-line">
										<f:input type="text" class="form-control" name="name" path="caseName" id="caseName"/>
