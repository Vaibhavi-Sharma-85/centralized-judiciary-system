					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ul class="breadcrumb breadcrumb-style ">
							<li class="breadcrumb-item">
								<h4 class="page-title">Hiring Document</h4>
							</li>
							<li class="breadcrumb-item bcrumb-1"><a
								href="../../index.html"> <i class="fas fa-home"></i> Home
							</a></li>
							<li class="breadcrumb-item bcrumb-2"><a href="#"
								onClick="return false;">View Hiring Date</a></li>
							<li class="breadcrumb-item active">Hiring Document</li>
						</ul>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								<strong>${hiringDocumentsVO.hiringVO.caseVO.caseName} (${hiringDocumentsVO.hiringVO.caseVO.caseNumber}) : Document</strong>
							</h2>
						</div>
								...
								<table
									...
									<c:forEach items="${hiringList}" var="i" varStatus="j">
										<tr>
											<td>${j.count}</td>
											<td><a
												href="<%=request.getContextPath()%>/documents/hiringdocs/${i.hiringVO.caseVO.caseNumber}/${i.documentFileName}"
